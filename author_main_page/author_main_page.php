...
<head>
    ...
    <link rel="stylesheet" href="author_main_page.css"></link>
    <script src="author_main_page.js"></script>
...
<!-- main body-->
<h2 style="color:#dee2e6; font-style:italic; position:relative; margin-top:12px;background-color:#332d2d;margin-bottom:-50px;padding-top:10px; padding-bottom:30px"><center>Authors:</center></h2>
...
<center>
<div style="width:98%;">
<?php $author_obj->get_authors_for_author_page(); ?>
</div>
</a>
</div>
</center>
