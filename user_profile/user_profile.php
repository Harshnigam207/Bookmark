...
<head>
    ...
    <link rel="stylesheet" href="user_profile.css"></link>
...
<!-- main body-->
<h2 style="color:#dee2e6; font-style:italic; position:relative; margin-top:12px;background-color:#332d2d;margin-bottom:-50px;padding-top:10px; padding-bottom:30px"><center>Your Profile:</center></h2>
...
<center>
<div style="width:97%; margin-left:-13px; " >
<form action="user_profile.php" method="post">
<?php $user_obj->user_profile_page(); ?>
</form>
</div>
...
<h2 style="color:#dee2e6; font-style:italic; position:relative; margin-top:12px;background-color:#332d2d;margin-bottom:-20px;padding-top:10px;" class="mt-5"><center>Books Uploaded by you:</center></h2>
<!-- main body-->
<div class="mt-2 signer" id="signer" name="signer" style="background-color:#332d2d; min-height: 600px;  width: auto; overflow:auto;" >


<div style="position:relative; left:3vw; width:94%; height:100%;" >
<div id="books_div">
    <center>

<?php $book_obj->get_book_for_user_profile_users_books();?>
    </center>
</div>
