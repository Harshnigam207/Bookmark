...
<head>
    ...
    <link rel="stylesheet" href="classics.css"></link>
...
<div class="main_container" id="main_container" name="main_container" >
    ...
    <script>
        ...
        <div class="container">
        <input type="text" placeholder="Search books" id="searchbar" class="searchbar" name="searchbar" style="position:absolute; left: -6%;" onfocus="searchbar_coloradd()" onkeydown="searching(event)" onblur="searchbar_colorremove()" onkeyup="showbook(this.value)" autocomplete="off">
...
<!-- main body-->
<h2 style="color:#dee2e6; font-style:italic; position:relative; margin-top:12px;background-color:#332d2d;margin-bottom:-50px;padding-top:10px; padding-bottom:30px"><center>Classic Books:</center></h2>
...
<center>
<div style="width:98%;">
<?php $book_obj->get_book_for_classics_page(); ?>
</div>
</a>
</div>
</center>
