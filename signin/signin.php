...
<div class="main_container" id="main_container" name="main_container" >
    ...
    <li><a class="dropdown-item" href="signin.php" style="background-color:#332d2d; color:#dee2e6;">SignIn</a></li>
...
<div class="container signin_form" style="width: 60%; margin-top:380px">
            <center style="padding-top:23px;">
                <h2 style="background-color:transparent;color:#dee2e6;">Sign In.</h2>
                <form action="signin.php" enctype="multipart/form-data" method="post" id="user_form">
                ...
                <button type="submit" class="btn" style="border:2px solid #dee2e6; color:#dee2e6; margin-bottom:20px;" id="sub" name="sub" onclick="submit_check(event)">SignIn</button>
