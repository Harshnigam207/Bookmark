...
<head>
    ...
    <link rel="stylesheet" href="autobiography.css"></link>
    <script src="autobiography.js"></script>
...
<!-- main body-->
<h2 style="color:#dee2e6; font-style:italic; position:relative; margin-top:12px;background-color:#332d2d;margin-bottom:-50px;padding-top:10px; padding-bottom:30px"><center>Autobiography Books:</center></h2>
...
<center>
<div style="width:98%;">
<?php $book_obj->get_book_for_autobiography_page(); ?>
</div>
</a>
</div>
</center>
