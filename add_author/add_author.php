...
if(isset($_POST["sub"])){
    ...
    $author_obj->insert_author_values();
    $author_obj->insert_author();
...
<head>
    ...
    <link rel="stylesheet" href="add_author.css"></link>
    <script src="add_author.js"></script>
...
<div class="container signin_form" style="width: 60%; margin-top:180px">
            <center style="padding-top:23px;">
                <h2 style="background-color:transparent;color:#dee2e6;">Add an Author.</h2>
                <form action="author_page.php" enctype="multipart/form-data" method="post" id="user_form">
                <div class="mb-3 mt-3">
                <label for="author_photo" style="background-color:transparent;color:#dee2e6;" id="author_photo_label">Author's photo:<i class="fa-solid fa-check text_stroke" id="photo_correct"></i></label><br>
                <label style="background-color:#332d2d; color:#dee2e6; height:50px; width:50px; border-radius:50%;border:2px solid #dee2e6;"><i class="fa-solid fa-plus inline_block" style="margin-top: 15px;"><input type="file" class="form-control inline_block" id="author_photo" name="author_photo" onclick="photo_check()" onchange="photo_check()"></i></label>
                ...
                <strong>Warning!</strong> Please enter author's picture.
                </div>
                </div>
                <div class="mb-3 mt-3">
                <label for="author_name" style="background-color:transparent;color:#dee2e6;">Author's Name: <i class="fa-solid fa-check text_stroke" id="name_correct"></i></label>
                <input type="text" class="form-control" id="author_name" placeholder="Enter Author's name" name="author_name" style="background-color:transparent;border:2px solid #dee2e6; color:#dee2e6; width:70%;" onblur="name_check()" onkeyup="name_check()" >
                ...
                <strong>Warning!</strong> Please enter author's name.
                </div>
                </div>
                <div class="mb-3 mt-3">
                <label for="website" style="background-color:transparent;color:#dee2e6;">Optional-Website: <i class="fa-solid fa-check text_stroke" id="website_correct"></i></label>
                <input type="url" class="form-control" id="website" placeholder="Enter author's website" name="website" style="background-color:transparent;border:2px solid #dee2e6; color:#dee2e6; width:70%;" onblur="website_check()" onkeyup="website_check()">
                </div>
                <div class="mb-3 mt-3">
                <label for="from" style="background-color:transparent;color:#dee2e6;">From: <i class="fa-solid fa-check text_stroke" id="from_correct"></i></label>
                <input type="text" class="form-control" id="from" placeholder="Enter Where the author is from" name="author_from" style="background-color:transparent;border:2px solid #dee2e6; color:#dee2e6; width:70%;" onblur="from_check()" onkeyup="from_check()">
                <div class="alert mb-2 mt-2 warnings" id="from_error" style="background-color:transparent;border:2px solid red; color:red; width:70%;">
                ...
                <input type="date" class="form-control" id="dob" name="dob" style="background-color:transparent;border:2px solid #dee2e6; color:#dee2e6; width:70%;" onchange="dob_check()" onclick="dob_check()">
                ...
                <strong>Warning!</strong> Please enter Author's date of birth.
                </div>
                </div>

                <div class="mb-3 mt-3">
                <label for="author_discription" style="background-color:transparent;color:#dee2e6;">Author's discription: <i class="fa-solid fa-check text_stroke" id="discription_correct"></i></label>
                <textarea rows="4" cols="50" maxlength="50000" class="form-control" id="author_discription" placeholder="Enter Author's discription" name="author_discription" style="background-color:transparent;border:2px solid #dee2e6; color:#dee2e6; width:70%;" onblur="author_discription_check()" onkeyup="author_discription_check()"></textarea>
                ...
                <strong>Warning!</strong> Please enter author's discription.
                </div>
                </div>
