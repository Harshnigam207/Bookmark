...
<head>
    ...
    <link rel="stylesheet" href="author_page.css"></link>
...
<!-- main body-->
<h2 style="color:#dee2e6; font-style:italic; position:relative; margin-top:12px;background-color:#332d2d;margin-bottom:-50px;padding-top:10px; padding-bottom:30px"><center>Book Details:</center></h2>
...
<h2 style="color:#dee2e6; font-style:italic; position:relative; margin-top:12px;background-color:#332d2d;margin-bottom:-20px;padding-top:10px;" class="mt-5"><center>Author's books</center></h2>
<!-- main body-->
...
<?php $book_obj->get_book_for_author_page_authors_books();?>
    </center>
</div>
