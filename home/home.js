...
function outerWidth1() {
  ...
  if (a >= 861) {
    let classer = document.getElementById("displayer").classList;
    document.getElementById("signer_1").style.maxHeight = "800px";
    classer.remove("displayer_responsive");
    classer.add("displayer");
  } else {
    let classer = document.getElementById("displayer").classList;
    document.getElementById("signer_1").style.maxHeight = "none";
    classer.add("displayer_responsive");
    classer.remove("displayer");
  }
}
...
let books_div_jumper = 0;
let books_div_jumper_counter = 0;

function book_div_left() {
  if (books_div_jumper_counter > 0) {
    books_div_jumper = books_div_jumper + 358;
    document.getElementById("books_div").style.transition = "0.3s margin-left linear";
    document.getElementById("books_div").style.marginLeft = books_div_jumper + "px";
    books_div_jumper_counter--;
  }
}

function book_div_right() {
  if (books_div_jumper_counter < 8) {
    books_div_jumper = books_div_jumper - 358;
    document.getElementById("books_div").style.transition = "0.3s margin-left linear";
    document.getElementById("books_div").style.marginLeft = books_div_jumper + "px";
    books_div_jumper_counter++;
...
let books_div2_jumper = 0;
let books_div2_jumper_counter = 0;

function book_div2_left() {
  if (books_div2_jumper_counter > 0) {
    books_div2_jumper = books_div2_jumper + 358;
    document.getElementById("books2_div").style.transition = "0.3s margin-left linear";
    document.getElementById("books2_div").style.marginLeft = books_div2_jumper + "px";
    books_div2_jumper_counter--;
  }
}

function book_div2_right() {
  if (books_div2_jumper_counter < 8) {
    books_div2_jumper = books_div2_jumper - 358;
    document.getElementById("books2_div").style.transition = "0.3s margin-left linear";
    document.getElementById("books2_div").style.marginLeft = books_div2_jumper + "px";
    books_div2_jumper_counter++;
...
function href_check() {
  ...
  if (user_id == "SignIn" || user_photo == "../bookmark_images/img_avatar1.png") {
    ...
    document.getElementById("user_href").href =
      "../user_profile/user_profile.php?linker=" + user_id;
  }
}
