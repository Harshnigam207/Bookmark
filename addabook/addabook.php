...
if(isset($_POST["sub"])){
    ...
    $book_obj->insert_book_values();
    $book_obj->insert_book();
...
<head>
    ...
    <link rel="stylesheet" href="addabook.css"></link>
    <script src="addabook.js"></script>
...
<!-- main body-->
<div class="container-fluid mt-2 signer" style="height: 1110px;  width: 100%; overflow:auto;" id="signer">
<div class="container signin_form mt-5 mb-5" style="width: 60%;">
            <center style="padding-top:23px;">
                <h2 style="background-color:transparent;color:#dee2e6;">Add a book.</h2>
                <form action="addabook.php" enctype="multipart/form-data" method="post" id="user_form">
                <div class="mb-3 mt-3">
                ...
                <a href="#" class="list-group-item" style="background-color:transparent; color:#dee2e6;" name="genres_my"  id="genres_my" onclick="genres_my()">Mythology</a>
                ...
                <li class="rating_list" style="margin-left:-7%;"><i class="fa-regular fa-star" id="star1" name="star1" onclick="first_star()"></i></li>
                ...
                <label style="background-color:transparent;color:#dee2e6;"><?php echo $book_obj->$str;?></label>
                </div>
